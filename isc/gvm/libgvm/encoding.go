...
func (v *Uint128) Decode(b []byte) (interface{}, error) { return big.NewInt(0).SetBytes(b), nil }
...
func (v *Uint256) Decode(b []byte) (interface{}, error) { return big.NewInt(0).SetBytes(b), nil }
...
func (v *Int128) Decode(b []byte) (interface{}, error) { return big.NewInt(0).SetBytes(b), nil }
...
func (v *Int256) Decode(b []byte) (interface{}, error) { return big.NewInt(0).SetBytes(b), nil }
...
func (v Uint8) Decode(b []byte) (interface{}, error) { return b[0], nil }
...
func (v Uint16) Decode(b []byte) (interface{}, error) { return util.BytesToUint16(b), nil }
...
func (v Uint32) Decode(b []byte) (interface{}, error) { return util.BytesToUint32(b), nil }
...
func (v Uint64) Decode(b []byte) (interface{}, error) { return util.BytesToUint64(b), nil }
...
func (v Int8) Decode(b []byte) (interface{}, error) { return int8(b[0]), nil }
...
func (v Int16) Decode(b []byte) (interface{}, error) { return util.BytesToInt16(b), nil }
...
func (v Int32) Decode(b []byte) (interface{}, error) { return util.BytesToInt32(b), nil }
...
func (v Int64) Decode(b []byte) (interface{}, error) { return util.BytesToInt64(b), nil }
...
func (v Bytes) Decode(b []byte) (interface{}, error) { return b, nil }
...
func (v String) Decode(b []byte) (interface{}, error) { return string(b), nil }
